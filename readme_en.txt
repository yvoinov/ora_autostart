...
init.oracle          - main autostart control script
oracle.conf          - autostart config file
oracle.xml           - service manifest for SMF
install.sh           - autostart installation script
install.conf         - installation script config file
remove.sh            - autostart remove script
remove.conf          - remove script config file
